...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="xlf12:target/xlf12:mrk[@mtype='seg']//xlf12:mrk[@mtype='protected']">
    ...
    <xsl:template match="xlf12:trans-unit[not(@translate)]/xlf12:target/xlf12:mrk[@mtype='seg']//xlf12:ph">
    ...
    <xsl:template match="xlf12:trans-unit[not(@translate)]/xlf12:target/xlf12:mrk[@mtype='seg']//xlf12:bpt">
        <xsl:text>&lt;g id="</xsl:text><xsl:value-of select="@id"/><xsl:text>"&gt;</xsl:text>
    </xsl:template>
    <xsl:template match="xlf12:trans-unit[not(@translate)]/xlf12:target/xlf12:mrk[@mtype='seg']//xlf12:ept">
        <xsl:text>&lt;/g&gt;</xsl:text>
    </xsl:template>
